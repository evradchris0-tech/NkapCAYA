...
export default function ChartCard({ title, subtitle, className, children, action }: ChartCardProps) {
  return (
    <div className={clsx('rounded-xl border border-primary-100/60 shadow-card overflow-hidden', className)} style={{ background: 'linear-gradient(135deg, #ffffff 0%, #f6f7f9 100%)' }}>
